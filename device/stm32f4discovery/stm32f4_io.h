...
{
	REG_SET_WAIT(RCC->AHB1ENR, 1UL << GPIO_PORT_Val(gpio));
...
{
public:
	PortT( void ) { REG_SET_WAIT(RCC->AHB1ENR, 1UL << GPIO_PORT_Val(gpio)); }
...
{
public:
	PinT( void ) { REG_SET_WAIT(RCC->AHB1ENR, 1UL << GPIO_PORT_Val(gpio)); }
