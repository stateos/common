/******************************************************************************
   ...
   @file    stm32f051x8_io.h
   @author  Rajmund Szymanski
   @date    24.05.2022
   @brief   This file contains macro definitions for the STM32F051x8 GPIO ports
...
#ifndef __STM32F051X8_IO_H
#define __STM32F051X8_IO_H
...
#define GPIO_PORT_Val(gpio) (_FLD2VAL(GPIO_PORT, gpio) + 17U)
