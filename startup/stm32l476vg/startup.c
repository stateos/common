...
__WEAK_ALIAS(Fault_Handler) void PVD_PVM_IRQHandler            (void);
...
__WEAK_ALIAS(Fault_Handler) void TIM1_TRG_COM_IRQHandler       (void);
...
__WEAK_ALIAS(Fault_Handler) void DFSDM1_FLT3_IRQHandler        (void);
...
__WEAK_ALIAS(Fault_Handler) void DFSDM1_FLT0_IRQHandler        (void);
__WEAK_ALIAS(Fault_Handler) void DFSDM1_FLT1_IRQHandler        (void);
__WEAK_ALIAS(Fault_Handler) void DFSDM1_FLT2_IRQHandler        (void);
__WEAK_ALIAS(Fault_Handler) void COMP_IRQHandler               (void);
__WEAK_ALIAS(Fault_Handler) void LPTIM1_IRQHandler             (void);
__WEAK_ALIAS(Fault_Handler) void LPTIM2_IRQHandler             (void);
__WEAK_ALIAS(Fault_Handler) void OTG_FS_IRQHandler             (void);
__WEAK_ALIAS(Fault_Handler) void DMA2_Channel6_IRQHandler      (void);
__WEAK_ALIAS(Fault_Handler) void DMA2_Channel7_IRQHandler      (void);
__WEAK_ALIAS(Fault_Handler) void LPUART1_IRQHandler            (void);
...
__WEAK_ALIAS(Fault_Handler) void SWPMI1_IRQHandler             (void);
