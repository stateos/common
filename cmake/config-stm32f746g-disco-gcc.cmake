...
set(TARGET_PLATFORM "stm32f746g-disco")
set(TARGET_CHIP     "stm32f746ng")
set(TARGET_DEVICE   "stm32f7")
set(TARGET_CORE     "cortex-m7")
...
function(setup_target target)
	...
	if ((nofpu IN_LIST ARGN) OR (${__NOFPU}))
		...
		set(FPU_FLAGS -mfpu=fpv5-sp-d16 -mfloat-abi=soft -ffast-math)
	else()
		message(STATUS "${STARTMSG} Using hardware floats")
		set(FPU_FLAGS -mfpu=fpv5-sp-d16 -mfloat-abi=hard -ffast-math)
	endif()
	...
	target_compile_definitions(${target} PRIVATE STM32F746xx)
